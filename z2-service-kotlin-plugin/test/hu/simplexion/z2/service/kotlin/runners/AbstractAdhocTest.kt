...
open class AbstractAdhocTest : BaseTestRunner(), RunnerWithTargetBackendForTestGeneratorMarker {
    ...
    override fun TestConfigurationBuilder.configuration() {
        ...
        useCustomRuntimeClasspathProviders(AbstractAdhocTest::ServiceRuntimeClassPathProvider)
    ...
    class ServiceRuntimeClassPathProvider(testServices: TestServices) : RuntimeClasspathProvider(testServices) {
